...
<div class="page-wrapper">
  ...
  <div class="row page-titles">
    <div class="col-md-5 align-self-center">
      <h3 class="text-primary">Gestión de Facturas</h3>
    </div>
          ...
          <div class="card-body">
            <div class="input-states">
              <form class="form-horizontal" method="POST" action="php_action/createOrder.php" id="createOrderForm" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  <div class="row">
                    ...
                    <div class="col-sm-4">
                      ...
                      ?>
                      <input type="text" class="form-control" placeholder="Número de Factura" autocomplete="off" value="<?php echo $new; ?>" required />
                    </div>
                ...
                <div class="form-group">
                  <div class="row">
                    <label class="col-sm-2 control-label">Nombre de Cliente</label>
                    <div class="col-sm-4">
   ...
   <option value="0">- Select -</option></select>  -->
        ...
        <div class="form-group">
          <div class="row">
            ...
            <label for="clientContact" class="col-sm-2 control-label">Forma de Pago</label>
            <div class="col-sm-4">
              <select class="form-control" name="paymentPlace" id="paymentPlace">
                <option value="">~~Seleccionar~~</option>
                <option value="1">En la tienda</option>
        ...
        <div class="form-group submitButtonFooter">
          <div class="col-sm-offset-2 col-sm-10">
            <button type="submit" id="createOrderBtn" data-loading-text="Cargando..." class="btn btn-success btn-flat m-b-30 m-t-30"><i class="glyphicon glyphicon-ok-sign"></i> Enviar</button>
  ...
  $(document).ready(function() {
    ...
    if (divRequest == 'add') {
      ...
      $("#createOrderForm").unbind('submit').bind('submit', function() {
        ...
        // form validation 
        if (orderDate == "") {
          $("#orderDate").after('<p class="text-danger"> La fecha de la orden es un campo requerido </p>');
        ...
        if (clientName == "") {
          $("#clientName").after('<p class="text-danger"> El campo nombre de cliente es requerido </p>');
        ...
        if (clientContact == "") {
          $("#clientContact").after('<p class="text-danger"> El campo de contacto del cliente es requerido </p>');
        ...
        if (paid == "") {
          $("#paid").after('<p class="text-danger"> El campo de pago es requerido </p>');
        ...
        if (paymentType == "") {
          $("#paymentType").after('<p class="text-danger"> El campo tipo de pago es requerido </p>');
        ...
        if (paymentStatus == "") {
          $("#paymentStatus").after('<p class="text-danger"> El campo estado del pago es requerido </p>');
        ...
        for (var x = 0; x < productName.length; x++) {
          ...
          if (productName[x].value == '') {
            $("#" + productNameId + "").after('<p class="text-danger"> El campo nombre del producto es requerido </p>');
        ...
        for (var x = 0; x < quantity.length; x++) {
          ...
          if (quantity[x].value == '') {
            $("#" + quantityId + "").after('<p class="text-danger"> El campo nombre de producto es requerido!! </p>');
      ...
      $("#editOrderForm").unbind('submit').bind('submit', function() {
        ...
        // form validation 
        if (orderDate == "") {
          $("#orderDate").after('<p class="text-danger"> El campo de fecha de orden es requerido </p>');
          $('#orderDate').closest('.form-group').addClass('has-error');
        } else {
          $('#orderDate').closest('.form-group').addClass('has-success');
        } // /else
        ...
        if (clientContact == "") {
          $("#clientContact").after('<p class="text-danger"> El campo de contacto es requerido </p>');
          $('#clientContact').closest('.form-group').addClass('has-error');
        } else {
          $('#clientContact').closest('.form-group').addClass('has-success');
        } // /else
        ...
        if (paymentStatus == "") {
          $("#paymentStatus").after('<p class="text-danger"> El campo estado de pago es requerido </p>');
          $('#paymentStatus').closest('.form-group').addClass('has-error');
        } else {
          $('#paymentStatus').closest('.form-group').addClass('has-success');
        } // /else
        ...
        for (var x = 0; x < productName.length; x++) {
          var productNameId = productName[x].id;
          if (productName[x].value == '') {
            $("#" + productNameId + "").after('<p class="text-danger"> El campo nombre de producto es requerido!! </p>');
            $("#" + productNameId + "").closest('.form-group').addClass('has-error');
          } else {
            $("#" + productNameId + "").closest('.form-group').addClass('has-success');
          }
        ...
        for (var x = 0; x < quantity.length; x++) {
          var quantityId = quantity[x].id;
          if (quantity[x].value == '') {
            $("#" + quantityId + "").after('<p class="text-danger"> Campo nombre de producto es requerido!! </p>');
            $("#" + quantityId + "").closest('.form-group').addClass('has-error');
          } else {
            $("#" + quantityId + "").closest('.form-group').addClass('has-success');
          }
    ...
    if (orderId) {
      ...
      $.ajax({
        ...
        success: function(response) {
          ...
          var mywindow = window.open('', 'Systema de Factura', 'height=400,width=600');
          mywindow.document.write('<html><head><title>Factura Número</title>');
