    ...
    <div class="container-fluid">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <a href="add-invoice.php"><button class="btn btn-primary">Agregar Factura</button></a>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><?php if ($row['payment_status'] == 1) {
                                            ...
                                            $paymentStatus = "<label class='label label-success' ><h4>Pago Total</h4></label>";
                                            echo $paymentStatus;
                                        } else if ($row['payment_status'] == 2) {
                                            $paymentStatus = "<label class='label label-danger'><h4>Avance</h4></label>";
                                            echo $paymentStatus;
                                        } else {
                                            $paymentStatus = "<label class='label label-warning'><h4>Sin Pagar</h4></label>";
                                            echo $paymentStatus;
                                        } // /els
                                        ?></td>
                                    <td>
